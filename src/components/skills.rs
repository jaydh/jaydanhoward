...
pub fn GreatAt(cx: Scope) -> impl IntoView {
    view! { cx,
        <ul class="list-disc list-outside space-y-4">
            ...
            <li>
                Designing performant and fault-tolerant RESTful APIs
            </li>
            <li>
                Service telemetry and root cause analysis
            </li>
            <li>
                Leading teams
            </li>
            <li>
                Talking to stake holders
            </li>
            <li>
                Finding high value wins (especially the ones with low costs)
            </li>
            <li>
...
pub fn Beliefs(cx: Scope) -> impl IntoView {
    view! { cx,
        ...
        <ul class="list-disc list-outside space-y-4 mb-60">
            ...
            <li>"Everything in software is about getting things to communicate "well""</li>
            <ul class="list-none list-outside pl-8 space-y-4">
                <li>
                    "▫️ To people: other developers, business stakeholders, users, API consumers"
                </li>
                <li>
                    "▫️ To machines: clients to services, services to services, processes to processes"
                </li>
                <li>
                    "▫️ To present-tense code: interfaces between functions, classes, network calls"
                </li>
                <li>
                    "▫️ To past-tense code: gracefully handling old versions of code after deploying to prod"
                </li>
                <li>
                    "▫️ To future-tense code: today's code will happily swap in and out with tomorrow's code"
                </li>
            </ul>
            <li>
            ...
            <li>
                li>
                <li>Large multi-hundred-line PRs indicate pro
            </li>
            <ul class="list-none list-outside pl-8 space-y-4">
                <li>"▫️ Poor developer utilization"</li>
                <li>
                    "▫️ Slower and more painful feedback cycles (requested changes have to happen in the service code and in tests)"
                </li>
                <li>"▫️ Behind-the-scene iteration from single developer battling dragons"</li>
            </ul>
        </ul>
    }
}
