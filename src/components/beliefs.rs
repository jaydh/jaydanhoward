    ...
    view! {
        ...
        <ul class="list-none list-outside space-y-4 mb-60">
            ...
            <ul class="list-none list-outside pl-8 space-y-4">
                <li>r#"To people: other developers, business stakeholders, users, API consumers"#</li>
                <li>r#"To machines: clients to services, services to services, processes to processes"#</li>
                <li>r#"To present-tense code: interfaces between functions, classes, network calls"#</li>
                <li>r#"To past-tense code: gracefully handling old versions of code after deploying to prod"#</li>
                <li>r#"To future-tense code: today's code will happily swap in and out with tomorrow's code"#</li>
            </ul>
            ...
            <ul class="list-disc list-outside pl-8 space-y-4">
                ...
                <li>r#"Slower and more painful feedback cycles (requested changes have to happen in the service code and in tests)"#</li>
